            ...
            if mode == "point":
                if y < 400:
                    if x < 635:
                        ...
                        return int((x - 635) / 101) + 6
                    elif x < 1890:
                        return int((x - 1270) / 100) + 11
                    else:
                        return int((x - 1890) / 100) + 16
                elif y < 800:
                    if x < 635:
                        return int(x / 100) + 21
                    elif x < 1270:
                    ...
                    if x < 635:
                        ...
                        return int((x - 635) / 100) + 66
                    elif x < 1890:
                        return int((x - 1270) / 100) + 71
                    else:
                        return int((x - 1890) / 100) + 76

        '''定位选项,judgeX用于将图像中对象的位置映射到答题卡的逻辑位置。'''
